        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UserInfo>(entity =>
            {
                entity.HasKey(e => e.UserId)
                    .HasName("PK__UserInfo__CB9A1CFF9CC16994");

                entity.ToTable("UserInfo");

                entity.HasIndex(e => e.UserEmail, "UQ__UserInfo__D54ADF550FD65727")
                    .IsUnique();
            ...
            modelBuilder.Entity<UserNotification>(entity =>
            {
                entity.HasKey(e => e.NotificationId)
                    .HasName("PK__UserNoti__4BA5CEA9EC0FC569");
                ...
                entity.HasOne(d => d.User)
                    ...
                    .HasConstraintName("FK__UserNotif__userI__5070F446").OnDelete(DeleteBehavior.Cascade);
            });
